        ...
        {modelVersions.map((version) => (
          ...
          >
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-semibold text-gray-800">Version {version.id}</h2>
              ...
              <div className="space-y-8 animate-fadeIn">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <MetricCard label="Test Set" value={version.metrics.testDataset} />
                    <MetricCard label="Environment" value={version.metrics.Environment} />
                    <MetricCard label="GPU" value={version.metrics.GPU} />
                    <MetricCard label="Language" value={version.metrics.Language} />
                    <MetricCard label="Framework" value={version.metrics.Framework} />

                </div>

                <section className="space-y-4">
                  <h3 className="text-xl font-semibold text-gray-800">Overview</h3>
                  <p className="text-gray-600">{version.overview}</p>
                </section>
