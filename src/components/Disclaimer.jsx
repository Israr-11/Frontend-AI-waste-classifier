...
export default function Disclaimer() {
  return (
    <div className="p-6 max-w-4xl mx-auto text-center">
      ...
      <p className="mb-4">
        The AI Recycling Assistant provides recycling recommendations based on predictions from an image classification model.
      ...
      <p>We strive to offer the best results, but this assistant should be used as a guide, not as a final authority.</p>
    </div>
  );
}
